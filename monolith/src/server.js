...
//Get products by ID
app.get('/service/products/:id', (req, res) => res.json(products.find((product) => product.id === req.params.id)));

//Get all orders
app.get('/service/orders', (req, res) => res.json(orders));

//Get orders by ID
app.get('/service/orders/:id', (req, res) => res.json(orders.find((order) => order.id === req.params.id)));
